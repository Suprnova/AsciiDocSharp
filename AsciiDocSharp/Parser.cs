...
public partial class Parser
{
    ...
    public class InlineParser(string input)
    {
        ...
        public BaseInline[] Parse() => Pass().UnconstrainedQuotes().ConstrainedQuotes().Finish();
        ...
        {
            foreach (QuoteRegex pair in UnconstrainedQuoteRegexes) {
        ...
        {
            foreach (QuoteRegex pair in ConstrainedQuoteRegexes) {
                foreach (Match match in pair.Pattern.Matches(MutInput)) {
