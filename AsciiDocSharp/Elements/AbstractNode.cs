...
namespace AsciiDocSharp.Elements
{
	public abstract class AbstractNode
	{
		...
		public AbstractBlock Parent { get; private set; }
		...
		public string GetAttribute(string key, string defaultValue, string? fallbackName = null)
			=> Attributes.GetAttribute(key) ?? (fallbackName == null ? defaultValue : /*Document?.GetAttribute(fallbackName)*/null ?? defaultValue);
