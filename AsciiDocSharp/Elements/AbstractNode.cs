...
public abstract class AbstractNode
{
    ...
    /// <inheritdoc cref="AttributeList.SetAttribute(String, String, Boolean)"/>
    /// <remarks>
    /// Equivalent to <see cref="AttributeList.SetAttribute(String, String, Boolean)"/> on the <see cref="Attributes"/> property.
    /// </remarks>
...
public class AttributeList
{
    ...
    private HashSet<string> Options {
        ...
        get => new(Attributes.Keys.Where(k => k.EndsWith("-option")).Select(k => k.Replace("-option", "")));
